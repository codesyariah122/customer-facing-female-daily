...
/**
 * CardProductListView component <show CardProductListView component on the required page>
  ...
  return (
    <div className="hover:border-teal-primary relative flex flex-wrap rounded border border-transparent bg-white shadow-md">
      ...
      <div className="flex items-end py-5">
        <div className="border-platinum w-[227px] cursor-pointer rounded border p-2.5 text-center text-sm font-semibold">
          + Add to Cart
        </div>
      </div>
    </div>
