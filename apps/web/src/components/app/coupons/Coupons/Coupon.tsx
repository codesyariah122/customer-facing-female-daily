...
import { SkeletonPromotion } from '@components/app/commons';
      ...
      <div>
        ...
        <div className="mt-[20px]">
          ...
          <div className="mt-5">
            {promotions.length == 0 ? (
              <div>
                <strong className="font-semibold">{promotions.length}</strong>
                <span className="px-2">Coupon</span>
              </div>
            ) : (
              <div>
                <strong className="font-semibold">{promotions.length}</strong>
                <span className="px-2">Coupons</span>
              </div>
            )}
            <div className="mt-6">
