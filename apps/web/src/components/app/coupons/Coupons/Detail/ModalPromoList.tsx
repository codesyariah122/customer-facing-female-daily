                      ...
                      return (
                        <li key={index} className="pt-4">
                          <div className="flex justify-between">
                            ...
                            <div
                              className={`${item?.code === copiedCoupon ? 'bg-[#dfe3e8] text-white' : 'border-pink-primary text-pink-primary'} flex w-[93px] cursor-pointer justify-center rounded border py-2 text-xs font-semibold tracking-wide`}
